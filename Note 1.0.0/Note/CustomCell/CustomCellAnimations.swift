...
extension CustomCell {
    ...
    func markAnimation() {
        ...
        UIView.animate(withDuration: 0.7, delay: 0.3,
            ...
            mark.transform = CGAffineTransform(scaleX: 1.2, y: 1.2)
        }
    ...
    func headAnimation() {
        UIView.animate(withDuration: 0.7, delay: 0.2,
                       options: .curveEaseIn ) { [self] in
            headLabel.transform = CGAffineTransform(scaleX: 1.20, y: 1.20)
        }
    ...
    func bodyAnimation() {
        UIView.animate(withDuration: 0.7, delay: 0.3,
                       options: .curveEaseIn ) { [self] in
            noteLabel.transform = CGAffineTransform(scaleX: 1.1, y: 1.1)
        }
