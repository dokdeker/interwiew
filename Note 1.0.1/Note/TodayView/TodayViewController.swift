...
class TodayViewController: UIViewController {
    ...
    func loadTodayData() {
        if UserDefaults.standard.stringArray(forKey: "h") != nil &&
            ...
            UserDefaults.standard.array(forKey: "a") != nil
        {
            ...
            NoteData.amountLine = userDefaults.object(forKey: "a") as! [Int]
        ...
        if UserDefaults.standard.object(forKey: "firstStart") != nil {
            isFirstStart = userDefaults.object(forKey: "firstStart") as! Bool
...
extension TodayViewController: MethodDelegate {
    ...
    func saveTodayData() {
        ...
        userDefaults.set(NoteData.amountLine, forKey: "a")
        
        userDefaults.set(isFirstStart, forKey: "firstStart")
    }
