...
extension TodayViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case true:
            let amountLineCell = NoteData.amountLine[indexPath.row]
        ...
        if NoteData.isDone[indexPath.row] == false {
            let doneAction = UIContextualAction(style: .destructive, title: nil) { (_, _, completionHandler) in
                ...
                cell.setup(headText: NoteData.head[indexPath.row],
                           ...
                           amountLine: NoteData.amountLine[indexPath.row],
                           cell: cell)
    ...
    -> UISwipeActionsConfiguration? {
        let deleteAction = UIContextualAction(style: .destructive, title: nil) { (_, _, completionHandler) in
            ...
            NoteData.amountLine.remove(at: indexPath.row)
    ...
    func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        ...
        let amontLineCell = NoteData.amountLine[sourceIndexPath.row]
        ...
        NoteData.amountLine.remove(at: sourceIndexPath.row)
        ...
        NoteData.amountLine.insert(amontLineCell, at: destinationIndexPath.row)
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(NoteData.amountLine[indexPath.row])
        tableView.reloadRows(at: [indexPath], with: .fade)
